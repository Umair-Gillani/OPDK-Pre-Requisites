...
echo "" 
echo "" 
log1 " => Now You need to Install (Apigee Mirror Utility) on Management Node ONLY (or on machine which has internet access) for creating a local repo mirror of Apigee Software packages using this below command's."
