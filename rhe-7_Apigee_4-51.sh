...
echo ""
echo ""
log1 " => Install (Apigee Edge Version $VERSION) through Mirror"
cmd "bash /opt/apigee/data/apigee-mirror/repos/$VERSION apigeeprotocol="file://" apigeerepobasepath=/tmp/repos"
